...
ggsave("Powers3.jpeg", width = 30, height = 16, units = "cm", dpi = 600)
...
ggplot(data = Exposure_Chart,aes(x = factor(Sampling_Plan, levels =levels_1 ) ,y = MeanComparison, group = Baseline_Scenario,fill = Baseline_Scenario))+
  ...
  facet_wrap(~Cont_Spread)+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(y= "Relative Difference: Endpoint TAC", x = "Sampling Plan", color= "Process System", fill = "Process System")+
  scale_y_continuous(labels = percent)+
...
ggsave("Relative Exposure-Final.tiff", width = 30, height = 16, units = "cm", dpi = 600)
ggsave("Relative Exposure-Final.jpeg", width = 30, height = 16, units = "cm", dpi = 600)
