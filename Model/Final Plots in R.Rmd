...
ggsave("Figure 4 - Powers.tiff", width = 6.8, height = 3.7, units = "in", dpi = 600)
ggsave("Figure 4 - Powers.jpeg", width = 6.8, height = 3.7, units = "in", dpi = 600)
...
ggsave("Figure 3-Contamination_Progression.tiff", width = 6.8, height = 3.7, units = "in", dpi = 600)
ggsave("Figure 3-Contamination_Progression.jpeg", width = 6.8, height = 3.7, units = "in", dpi = 600)
...
ggplot(data= FSdf, aes(x = fct_reorder(Name, abs(FS)), y = FS, fill = System))+
  ...
  ggsave("Figure 6- Factor Sensitivity.jpeg", width = 6.8, height = 3.7, units = "in", dpi = 600)
  ggsave("Figure 6- Factor Sensitivity.tiff", width = 6.8, height = 3.7, units = "in", dpi = 600)
...
ggsave("Figure S2 - Contamination Samp Points.tiff", width = 6.8, height = 4.5, units = "in", dpi = 600)
ggsave("Figure S2 - Contamination Samp Points.jpeg", width = 6.8, height = 4.5, units = "in", dpi = 600)
...
ggsave("Relative Prevalence.tiff", width = 6.8, height = 4.5, units = "in",  dpi = 600)
...
ggsave("Figure 5 - Efficacy.tiff", width = 6.8, height = 3.7, units = "in", dpi = 600)
ggsave("Figure 5 - Efficacy.jpeg", width = 6.8, height = 3.7, units = "in", dpi = 600)
