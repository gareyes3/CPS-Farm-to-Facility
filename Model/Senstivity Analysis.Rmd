...
Sens_DF<-read.csv("PRCC Outs.csv")

ggplot(data = Sens_DF, aes(x=fct_reorder(X, abs(original)),y=original, fill = Cateogry))+
...
ggsave(filename= "SensitivityPlot.jpeg", height = 5, width =6.8, units = "in", dpi = 300)
ggsave(filename= "SensitivityPlot.tiff", height = 5, width =6.8, units = "in",dpi = 300)
